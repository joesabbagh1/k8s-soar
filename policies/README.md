...
Kyverno, Tetragon, and quarantine policies are **applied automatically** when you install via `./ansible/setup.sh` or `./ansible/setup.sh` (`scripts/apply-policies-lab.sh` runs after Helm).
